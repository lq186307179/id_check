        ...
        try:
            ...
            for i in aa:
                if i in list and len(aa) == 18 and end_num == end:
                    ...
                    file = open('C://Users/刘俊庆/Desktop/身份证归属地.txt', mode='r',encoding='utf-8')
                    text = file.readlines()
                    family = aa[:6]
                    for i in text:
                        if family in i:
